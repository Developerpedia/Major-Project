...
a:active{
 ...
 <div class="sidenav">
  ...
  <a href="adminpro.php" class="w3-bar-item w3-button"><i class="ion-person icon-small"></i> </i> Profile</a>
...
?>
  ...
  <div class="column">
    <div class="card3">
      <h3><i class="ion-checkmark-circled icon-big"></i>Courses</h3>
      <p>12</p>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card4">
      <h3><i class="ion-trophy icon-big"></i>Branches</h3>
      <p>5</p>
    </div>
  </div>
</div>
